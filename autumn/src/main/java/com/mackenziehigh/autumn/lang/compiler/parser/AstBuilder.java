...
public final class AstBuilder extends AbstractVisitor
{
     ...
     */
    public static autumn.lang.compiler.ast.nodes.Module build(final ITreeNode root)
    {
        final AstBuilder visitor = new AstBuilder();
        visitor.visit(root);
        return (autumn.lang.compiler.ast.nodes.Module) visitor.$stack.peek();
    }
     ...
     */
    @Override
    public void visit_once_expression(final ITreeNode $node)
    {
        final int $stack_size = $stack.size();
