...
+ Parameter condition is used to identify the sought after value.
+ Parameter skip is the number of matching elements to skip.
+ Parameter elements contains the elements to search through.
