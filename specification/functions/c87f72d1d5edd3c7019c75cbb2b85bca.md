...
+ Parameter minimumis the minimum integer in the sequence.
+ Parameter maximumis the maximum integer in the sequence.
+ Parameter stepis the size of each increment in the sequence.
