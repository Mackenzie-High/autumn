...
+ 0Really, this function is just a thin wrapper around the $format$ function in $JavaLangString$.
+ 1This function is provided, because the $format$ function takes an array rather than a list.
