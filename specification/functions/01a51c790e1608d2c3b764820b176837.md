...
+ Parameter iterable is the iterable to convert to a string.
+ Parameter prefix is a string to prepend onto the result.
+ Parameter separator is a string to place between each element in the result.
+ Parameter suffix is a string to append onto the result.
