...
Parametertargetis the object that the key-value pair will be weakly attached to.
Parameterkeyis the key part of the key-value pair.
Parametervalueis the value part of the key-value pair.
