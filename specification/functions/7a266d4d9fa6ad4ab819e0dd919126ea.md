...
+ Parameter target is the object that the key-value pair will be weakly attached to.
+ Parameter key is the key part of the key-value pair.
+ Parameter value is the value part of the key-value pair.
