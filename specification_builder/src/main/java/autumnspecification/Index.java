...
/**
 * This class is used to generate page: https://www.mackenziehigh.me/autumn/
 *
...
public final class Index
{
    ...
    public static void add (final String text,
                            final String href)
    {
        final String link = String.format("[%s](%s)", text, href);

        add(link);
    }

    /**
     * This method adds a line to the index, when the line is a link to a
     * construct-page.
     *
    ...
    {
        add(c.name, "specification/" + c.pageName());
    }
            ...
            throws IOException
    {
        ...
        {
            final var padding = Strings.repeat(" ", 4 * entry.getKey());
            markdown.append(padding).append("+ ").append(entry.getValue()).append("\n");
        }
        ...
        final File file = new File(JSONBuilder.SPECIFICATION, "index.md");
