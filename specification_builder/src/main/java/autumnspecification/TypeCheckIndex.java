...
/**
 * This class is used to generate page:
 * https://www.mackenziehigh.me/autumn/TypeCheckingExamplesIndexPage.html
 *
...
public final class TypeCheckIndex
{
    ...
    {
        table.add(Lists.newArrayList(test, construct, error));
    }
            ...
            throws IOException
    {
        ...
        markdown.append("# Examples of Compiler Warnings").append("\n");
        ...
        for (String key : sorted.keySet())
        {
            ...
            final var example = row.get(0);
            final var construct = (Class) row.get(1);
            final var errorcode = expand(row.get(2).toString());

            final File codefile = new File(STATIC_CHECKS + "/"+ "T" + Strings.padStart(example + "", 4, '0') + ".code");
            final File outfile = new File(STATIC_CHECKS + "/"+ "T" + Strings.padStart(example + "", 4, '0') + ".stdout");
            ...
            markdown.append("## ").append(construct.getSimpleName()).append(": ").append(errorcode).append("\n");
            markdown.append("\n");
        ...
        final File file = new File(JSONBuilder.SPECIFICATION, "Compiler_Warning_Examples.md");
    ...
    static
    {
        ...
        //add(StructDefinition.class, 164, CIRCULAR_INHERITANCE); TODO
        ...
        // add(TupleDefinition.class, 166, CIRCULAR_INHERITANCE); TODO
