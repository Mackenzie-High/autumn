...
/**
 * This class is used to generate page: https://www.mackenziehigh.me/autumn/FunctionIndexPage.html
 *
...
//        f.raise(NullPointerException.class, "if any of the iterables are null.", "iterables.contains(null)");
            ...
            throws IOException
    {
        ...
        markdown.append("# Special Functions").append("\n");
        markdown.append("\n");
        ...
        {
            final var text = "`" + x + "`";
            final var href = x.id() + ".md";
            final var link = String.format("[%s](%s)", text, href);
        ...
        final File file = new File(JSONBuilder.SPECIFICATION, "functions/README.md");
