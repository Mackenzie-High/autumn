...
public abstract class AbstractVisitor implements ITreeNodeVisitor
{
    ...
    public void visit(ITreeNode node)
    {
        ...
        else if("array".equals(name)) { visit_array(node); }
        else if("elements".equals(name)) { visit_elements(node); }
        else if("object".equals(name)) { visit_object(node); }
        else if("members".equals(name)) { visit_members(node); }
        else if("pair".equals(name)) { visit_pair(node); }
     ...
     */
    protected void visit_array(ITreeNode node)
    {
        // You should *not* place your code right here. 
        // Instead, you should override this method via a subclass.
        visitUnknown(node); // Default Behavior
     ...
     */
    protected void visit_members(ITreeNode node)
    {
        // You should *not* place your code right here. 
        // Instead, you should override this method via a subclass.
        visitUnknown(node); // Default Behavior
     ...
     */
    protected void visit_object(ITreeNode node)
    {
        // You should *not* place your code right here. 
        // Instead, you should override this method via a subclass.
        visitUnknown(node); // Default Behavior
     ...
     */
    protected void visit_pair(ITreeNode node)
    {
        // You should *not* place your code right here. 
        // Instead, you should override this method via a subclass.
        visitUnknown(node); // Default Behavior
