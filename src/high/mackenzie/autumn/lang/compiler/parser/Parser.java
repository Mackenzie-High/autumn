...
public final class Parser implements IParser
{
    ...
    private static Grammar grammar()
    {
        ...
        // Grammar Rules
        g.choose("@202", "@200", "@201");
        g.choose("@207", "@205", "@206");
        g.choose("@212", "@210", "@211");
        g.choose("@219", "@217", "@218");
        g.choose("@226", "@222", "@223", "@224", "@225");
        g.choose("@232", "@230", "@231");
        g.choose("@243", "@239", "@240", "@241", "@242");
        g.choose("@255", "DIGIT", "@254");
        g.choose("@276", "SP", "COMMENT");
        g.choose("@279", "@277", "@278");
        g.choose("@69", "do_until", "do_while");
        g.choose("COMMENT", "MULTI_LINE_COMMENT", "SINGLE_LINE_COMMENT");
        g.choose("ESCAPE_CHAR", "@267", "@268", "@269", "@270", "@271", "@272", "@273", "@274", "@275");
        g.choose("NON_QUOTE", "ESCAPE_SEQUENCE", "@260");
        g.choose("NON_TRIPLE_QUOTE", "ESCAPE_SEQUENCE", "@264", "@265");
        ...
        g.repeat("@149", "@148", 0, 2147483647);
        g.repeat("@151", "api_comment_line", 0, 2147483647);
        g.repeat("@154", "annotation", 0, 2147483647);
        g.repeat("@160", "@159", 0, 2147483647);
        g.repeat("@164", "@163", 0, 2147483647);
        g.repeat("@172", "@171", 0, 2147483647);
        g.repeat("@174", "@173", 0, 1);
        g.repeat("@180", "@179", 0, 2147483647);
        g.repeat("@182", "@181", 0, 1);
        g.repeat("@190", "@189", 1, 2147483647);
        g.repeat("@204", "@203", 0, 1);
        g.repeat("@209", "@208", 0, 1);
        g.repeat("@214", "@213", 0, 1);
        g.repeat("@216", "@215", 0, 1);
        g.repeat("@221", "@220", 0, 1);
        g.repeat("@228", "@227", 0, 1);
        g.repeat("@234", "@233", 0, 1);
        g.repeat("@237", "@236", 0, 1);
        g.repeat("@251", "@250", 0, 2147483647);
        g.repeat("@253", "@252", 1, 2147483647);
        g.repeat("@256", "@255", 0, 2147483647);
        g.repeat("@259", "@258", 0, 1);
        g.repeat("@281", "@280", 0, 2147483647);
        g.repeat("@288", "@287", 0, 2147483647);
        ...
        g.repeat("WS", "@276", 0, 2147483647);
        g.repeat("annotation_assignment_opt", "annotation_assignment", 0, 1);
        g.repeat("annotation_values", "@161", 0, 1);
        g.repeat("api_comment_text", "@153", 0, 2147483647);
        g.repeat("arguments", "@150", 0, 1);
        g.repeat("dimensions", "@185", 0, 2147483647);
        ...
        g.sequence("@148", "WS", "@147", "WS", "WS", "argument");
        g.sequence("@150", "argument", "@149", "WS");
        g.sequence("@159", "WS", "@158", "WS", "annotation_value");
        g.sequence("@161", "annotation_value", "@160", "WS");
        g.sequence("@163", "@162", "name_id");
        g.sequence("@165", "name_id", "@164");
        g.sequence("@171", "WS", "@170", "WS", "element");
        g.sequence("@173", "element", "@172");
        g.sequence("@179", "WS", "@178", "WS", "parameter");
        g.sequence("@181", "parameter", "@180");
        g.sequence("@185", "dimension", "WS");
        g.sequence("@189", "name_id", "@188");
        g.sequence("@20", "@19", "SP", "WS", "type", "WS");
        g.sequence("@254", "@253", "DIGIT");
        g.sequence("@264", "@261", "@263");
        g.sequence("@275", "DIGIT", "DIGIT", "DIGIT", "DIGIT", "DIGIT");
        g.sequence("@287", "@285", "@286");
        g.sequence("@38", "WS", "@37", "WS", "label");
        g.sequence("@40", "label", "@39");
        g.sequence("@77", "@76", "SP");
        g.sequence("@9", "WS", "@8", "WS", "enum_constant");
        g.sequence("DIGITS", "DIGIT", "@256");
        g.sequence("ESCAPE_SEQUENCE", "@266", "ESCAPE_CHAR");
        g.sequence("EXPONENT", "@257", "@259", "DIGITS");
        g.sequence("ID", "@249", "@251");
        g.sequence("MULTI_LINE_COMMENT", "@283", "@288", "@289", "WS");
        g.sequence("SEMICOLON", "@248", "WS");
        g.sequence("SINGLE_LINE_COMMENT", "@279", "@281", "@282");
        ...
        g.sequence("annotation", "PS", "@155", "WS", "annotation_type", "WS", "annotation_assignment_opt", "WS");
        g.sequence("annotation_assignment", "@156", "WS", "annotation_values", "WS", "@157", "WS");
        g.sequence("annotation_definition", "PS", "api_comment", "annotation_list", "WS", "@3", "SP", "WS", "name", "WS", "SEMICOLON", "WS");
        g.sequence("annotation_list", "PS", "@154");
        g.sequence("annotation_type", "type");
        g.sequence("annotation_value", "string_value");
        g.sequence("api_comment", "PS", "@151");
        g.sequence("api_comment_line", "PS", "WS", "@152", "api_comment_text", "WS");
        g.sequence("argument", "expression");
        g.sequence("argument_list", "@145", "WS", "arguments", "WS", "@146", "WS");
        ...
        g.sequence("big_decimal_value", "@237", "DIGITS", "@238", "DIGITS", "EXPONENT_OPT", "WS", "@243", "WS");
        g.sequence("big_integer_datum", "big_integer_value");
        g.sequence("big_integer_value", "@221", "DIGITS", "@226", "WS");
        ...
        g.sequence("byte_value", "@204", "DIGITS", "@207", "WS");
        ...
        g.sequence("class_value", "@245", "SP", "WS", "type", "WS");
        ...
        g.sequence("dimension", "@186", "WS", "@187");
        ...
        g.sequence("double_value", "@234", "DIGITS", "@235", "DIGITS", "EXPONENT_OPT", "WS");
        g.sequence("element", "PS", "name", "WS", "@176", "WS", "type", "WS");
        g.sequence("elements", "PS", "@169", "WS", "@174", "WS", "@175", "WS");
        ...
        g.sequence("false", "@195", "@196", "WS");
        g.sequence("filepath", "string_value");
        g.sequence("float_datum", "float_value");
        g.sequence("float_value", "@228", "DIGITS", "@229", "DIGITS", "EXPONENT_OPT", "@232", "WS");
        ...
        g.sequence("formals", "PS", "@177", "WS", "@182", "WS", "@183", "WS");
        ...
        g.sequence("namespace_explicit", "PS", "@165");
        ...
        g.sequence("null_value", "@246", "@247", "WS");
        g.sequence("numeric_char_value", "DIGITS", "@202", "WS");
        ...
        g.sequence("parameter", "PS", "variable", "WS", "@184", "WS", "type", "WS");
        ...
        g.sequence("short_value", "@209", "DIGITS", "@212", "WS");
        g.sequence("signature", "name", "WS", "formals", "WS", "@166", "WS", "return_type", "WS");
        ...
        g.sequence("static_owner_explicit", "type", "WS", "@192");
        ...
        g.sequence("supers", "@167", "WS", "supers_list", "WS");
        g.sequence("supers_list_cons", "type", "WS", "@168", "WS", "supers_list");
        ...
        g.sequence("type_namespace_explicit", "PS", "@190");
        ...
        g.sequence("verbatim_string_value", "@244", "WS", "STRING_LITERAL", "WS");
