...
public final class Parser implements IParser
{
    ...
    private static Grammar grammar()
    {
        ...
        g.repeat("@127", "@126", 0, 1);
        g.repeat("@129", "@128", 0, 1);
        g.repeat("@142", "@141", 0, 2147483647);
        g.repeat("@148", "@147", 0, 2147483647);
        g.repeat("@150", "@149", 0, 1);
        g.repeat("@155", "@154", 0, 2147483647);
        g.repeat("@162", "@161", 1, 2147483647);
        g.repeat("@174", "@173", 0, 1);
        g.repeat("@177", "@176", 0, 1);
        g.repeat("@180", "@179", 0, 1);
        g.repeat("@182", "@181", 0, 1);
        g.repeat("@185", "@184", 0, 1);
        g.repeat("@189", "@188", 0, 1);
        g.repeat("@198", "@197", 0, 2147483647);
        g.repeat("@203", "@202", 0, 2147483647);
        g.repeat("@215", "@214", 0, 2147483647);
        g.repeat("@222", "@221", 0, 2147483647);
        g.repeat("@5", "annotation", 0, 2147483647);
        g.repeat("@65", "@64", 0, 1);
        g.repeat("DIGITS", "@199", 1, 2147483647);
        ...
        g.repeat("WS", "@210", 0, 2147483647);
        g.repeat("arguments", "@156", 0, 1);
        g.repeat("design_members", "design_member", 0, 2147483647);
        g.repeat("dimensions", "@157", 0, 2147483647);
        ...
        g.sequence("@141", "@140", "name_id");
        g.sequence("@143", "name_id", "@142");
        g.sequence("@147", "WS", "@146", "WS", "parameter");
        g.sequence("@149", "parameter", "@148");
        g.sequence("@154", "WS", "@153", "WS", "WS", "argument");
        g.sequence("@156", "argument", "@155", "WS");
        g.sequence("@157", "dimension", "WS");
        g.sequence("@161", "name_id", "@160");
        g.sequence("@207", "@204", "@206");
        g.sequence("@221", "@219", "@220");
        g.sequence("EXPONENT", "@200", "@201", "@203");
        g.sequence("ID", "@196", "@198");
        g.sequence("MULTI_LINE_COMMENT", "@217", "@222", "@223", "WS");
        g.sequence("SEMICOLON", "@195", "WS");
        g.sequence("SINGLE_LINE_COMMENT", "@213", "@215", "@216");
        ...
        g.sequence("byte_value", "@174", "DIGITS", "@175", "WS");
        g.sequence("call_method_expression", "PS", "@127", "WS", "instance_member_access", "arguments", "WS");
        g.sequence("call_static_method_expression", "PS", "@129", "WS", "static_member_access", "arguments", "WS");
        g.sequence("char_datum", "char_value");
        g.sequence("class_datum", "class_value", "WS");
        g.sequence("class_value", "@191", "WS", "@192", "WS", "type", "WS", "@193", "WS");
        ...
        g.sequence("create_expression", "PS", "@138", "WS", "type", "WS", "wraps_opt", "WS");
        g.sequence("debug_statement", "PS", "@33", "WS", "SEMICOLON");
        g.sequence("delegate_expression", "PS", "formals", "WS", "@115", "WS", "static_member_access", "WS");
        g.sequence("delegate_expression_simplified", "PS", "@116", "WS", "static_member_access", "WS");
        g.sequence("design_definition", "PS", "annotation_list", "WS", "@10", "WS", "name", "WS", "design_extends_opt", "WS", "@11", "WS", "design_members", "@12", "WS");
        g.sequence("design_extends", "@13", "WS", "extends_list");
        g.sequence("dimension", "@158", "WS", "@159");
        g.sequence("dispatch_expression", "PS", "@124", "WS", "name", "WS", "arguments", "WS");
        ...
        g.sequence("double_value", "@189", "DIGITS", "@190", "DIGITS", "EXPONENT_OPT", "WS");
        g.sequence("elif_case", "@28", "WS", "conditional_case", "WS");
        g.sequence("else_case", "@29", "WS", "sequence_statement", "WS");
        g.sequence("enum_constant", "PS", "annotation_list", "WS", "@22", "WS", "name", "WS", "SEMICOLON", "WS");
        g.sequence("enum_definition", "PS", "annotation_list", "WS", "@19", "WS", "name", "WS", "@20", "WS", "enum_constants", "WS", "@21", "WS");
        g.sequence("enum_value", "@194", "WS", "static_member_access", "WS");
        ...
        g.sequence("false", "@167", "@168", "WS");
        g.sequence("filepath", "string_value");
        g.sequence("float_datum", "float_value");
        g.sequence("float_value", "@185", "DIGITS", "@186", "DIGITS", "EXPONENT_OPT", "@187", "WS");
        ...
        g.sequence("formals", "PS", "@145", "WS", "@150", "WS", "@151", "WS");
        g.sequence("funcall_expression", "PS", "@111", "WS", "expression", "@114", "WS");
        g.sequence("function_definition", "PS", "annotation_list", "WS", "@23", "WS", "signature", "WS", "sequence_statement", "WS");
        g.sequence("get_field_expression", "PS", "@130", "WS", "instance_member_access", "WS");
        g.sequence("get_static_expression", "PS", "@133", "WS", "static_member_access", "WS");
        ...
        g.sequence("if_case", "@27", "WS", "conditional_case", "WS");
        ...
        g.sequence("instance_member_access", "expression", "WS", "@163", "WS", "name", "WS");
        g.sequence("instanceof_expression", "PS", "@136", "WS", "expression", "WS", "@137", "WS", "type", "WS");
        g.sequence("int_datum", "int_value");
        g.sequence("int_value", "@180", "DIGITS", "WS");
        ...
        g.sequence("list_expression", "PS", "@121", "WS", "arguments", "WS", "@122", "WS");
        g.sequence("literal_char_value", "@169", "@170", "@171", "WS");
        g.sequence("locals_expression", "PS", "@117", "WS");
        g.sequence("long_datum", "long_value");
        g.sequence("long_value", "@182", "DIGITS", "@183", "WS");
        g.sequence("marker_statement", "PS", "@32", "WS", "label", "WS", "SEMICOLON");
        g.sequence("method", "PS", "annotation_list", "WS", "@17", "WS", "name", "WS", "formals", "WS", "@18", "WS", "type", "WS", "SEMICOLON", "WS");
        g.sequence("method_statement", "PS", "@73", "WS", "variable", "WS", "@74", "WS", "name", "WS", "formals", "WS", "@75", "WS", "static_member_access", "WS", "SEMICOLON");
        ...
        g.sequence("namespace_explicit", "PS", "@143");
        g.sequence("negate_operation", "@103", "WS", "p8", "WS");
        g.sequence("nested_expression", "@107", "WS", "expression", "WS", "@108", "WS");
        g.sequence("new_expression", "PS", "@125", "WS", "type", "WS", "arguments", "WS");
        g.sequence("nop_statement", "PS", "@26", "SEMICOLON");
        ...
        g.sequence("numeric_char_value", "DIGITS", "@172", "WS");
        ...
        g.sequence("parameter", "PS", "variable", "WS", "@152", "WS", "type", "WS");
        g.sequence("paren_condition", "nested_expression");
        g.sequence("paren_expression", "nested_expression");
        g.sequence("progn_expression", "PS", "@123", "WS", "arguments", "WS");
        ...
        g.sequence("sequence_statement", "PS", "@24", "WS", "statements", "WS", "@25", "WS");
        g.sequence("set_field_expression", "PS", "@131", "WS", "instance_member_access", "@132", "WS", "expression", "WS");
        g.sequence("set_static_expression", "PS", "@134", "WS", "static_member_access", "WS", "@135", "WS", "expression", "WS");
        ...
        g.sequence("short_value", "@177", "DIGITS", "@178", "WS");
        g.sequence("signature", "name", "WS", "formals", "WS", "@144", "WS", "return_type", "WS");
        ...
        g.sequence("static_owner_explicit", "type", "WS", "@164");
        ...
        g.sequence("ternary_conditional_expression", "PS", "@118", "WS", "condition", "WS", "@119", "WS", "expression", "@120", "WS", "expression", "WS");
        g.sequence("throw_statement", "PS", "@36", "WS", "expression", "WS", "SEMICOLON");
        g.sequence("true", "@165", "@166", "WS");
        ...
        g.sequence("type_namespace_explicit", "PS", "@162");
        ...
        g.sequence("when_statement", "PS", "@30", "WS", "paren_condition", "WS", "statement", "WS");
        g.sequence("while_statement", "PS", "@55", "WS", "paren_condition", "WS", "sequence_statement", "WS");
        g.sequence("wraps", "@139", "WS", "expression", "WS");
