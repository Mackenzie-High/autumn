...
public final class Parser implements IParser
{
    ...
    private static Grammar grammar()
    {
        ...
        g.range("@class78", (char) 66, (char) 66);
        g.range("@class79", (char) 45, (char) 45);
        g.range("@class80", (char) 83, (char) 83);
        g.range("@class81", (char) 45, (char) 45);
        g.range("@class82", (char) 45, (char) 45);
        g.range("@class83", (char) 76, (char) 76);
        g.range("@class84", (char) 45, (char) 45);
        g.range("@class85", (char) 45, (char) 45);
        g.range("@class86", (char) 46, (char) 46);
        g.range("@class87", (char) 70, (char) 70);
        g.range("@class88", (char) 45, (char) 45);
        g.range("@class89", (char) 46, (char) 46);
        g.range("@class90", (char) 45, (char) 45);
        g.range("@class91", (char) 46, (char) 46);
        g.range("@class92", (char) 64, (char) 64);
        g.range("@class93", (char) 59, (char) 59);
        g.range("@class94", (char) 65, (char) 90);
        g.range("@class95", (char) 97, (char) 122);
        g.range("@class96", (char) 95, (char) 95);
        g.range("@class97", (char) 36, (char) 36);
        g.combine("@class98", "@class94", "@class95", "@class96", "@class97");
        ...
        g.range("@class103", (char) 48, (char) 57);
        g.combine("@class104", "@class99", "@class100", "@class101", "@class102", "@class103");
        g.range("@class105", (char) 95, (char) 95);
        g.range("@class106", (char) 48, (char) 57);
        g.range("@class107", (char) 101, (char) 101);
        g.range("@class108", (char) 69, (char) 69);
        g.combine("@class109", "@class107", "@class108");
        g.range("@class110", (char) 45, (char) 45);
        g.range("@class111", (char) 43, (char) 43);
        g.combine("@class112", "@class110", "@class111");
        g.range("@class113", (char) 34, (char) 34);
        g.range("@class114", (char) 34, (char) 34);
        g.combine("@class115", "@class114");
        g.negate("@class116", "@class115");
        g.range("@class117", (char) 39, (char) 39);
        g.combine("@class118", "@class117");
        g.negate("@class119", "@class118");
        g.range("@class120", (char) 92, (char) 92);
        g.range("@class121", (char) 116, (char) 116);
        g.range("@class122", (char) 98, (char) 98);
        g.range("@class123", (char) 110, (char) 110);
        g.range("@class124", (char) 114, (char) 114);
        g.range("@class125", (char) 102, (char) 102);
        g.range("@class126", (char) 34, (char) 34);
        g.range("@class127", (char) 92, (char) 92);
        g.range("@class128", (char) 35, (char) 35);
        ...
        g.range("@class133", (char) 10, (char) 10);
        g.range("@class134", (char) 13, (char) 13);
        g.combine("@class135", "@class133", "@class134");
        g.range("@class136", (char) 0, (char) 65535);
        g.combine("@class137", "@class136");
        ...
        g.range("@class142", (char) 13, (char) 13);
        g.combine("@class143", "@class141", "@class142");
        g.negate("@class144", "@class143");
        g.range("@class145", (char) 32, (char) 32);
        g.range("@class146", (char) 9, (char) 9);
        g.range("@class147", (char) 10, (char) 10);
        g.range("@class148", (char) 11, (char) 11);
        g.range("@class149", (char) 12, (char) 12);
        g.range("@class150", (char) 13, (char) 13);
        g.combine("@class151", "@class145", "@class146", "@class147", "@class148", "@class149", "@class150");

        // Grammar Rules
        g.choose("@238", "DIGIT", "@237");
        g.choose("@259", "SP", "COMMENT");
        g.choose("@262", "@260", "@261");
        g.choose("@70", "do_until", "do_while");
        g.choose("COMMENT", "MULTI_LINE_COMMENT", "SINGLE_LINE_COMMENT");
        g.choose("ESCAPE_CHAR", "@250", "@251", "@252", "@253", "@254", "@255", "@256", "@257", "@258");
        g.choose("NON_QUOTE", "ESCAPE_SEQUENCE", "@243");
        g.choose("NON_TRIPLE_QUOTE", "ESCAPE_SEQUENCE", "@247", "@248");
        ...
        g.choose("keyword_expression", "locals_expression", "dispatch_expression", "new_expression", "call_static_method_expression", "call_method_expression", "set_static_expression", "get_static_expression", "set_field_expression", "get_field_expression", "instanceof_expression", "ternary_conditional_expression", "progn_expression");
        ...
        g.chr("@94", "@class26");
        g.chr("@95", "@class27");
        g.chr("DIGIT", "@class106");
        g.chr("NEWLINE", "@class140");
        g.chr("NON_NEWLINE", "@class144");
        g.chr("QUOTE", "@class113");
        g.chr("SP", "@class151");
        g.not("@195", "ID");
        g.not("@197", "ID");
        g.not("@230", "ID");
        ...
        g.repeat("@206", "@205", 0, 1);
        g.repeat("@209", "@208", 0, 1);
        g.repeat("@211", "@210", 0, 1);
        g.repeat("@214", "@213", 0, 1);
        g.repeat("@217", "@216", 0, 1);
        g.repeat("@221", "@220", 0, 1);
        g.repeat("@224", "@223", 0, 1);
        g.repeat("@234", "@233", 0, 2147483647);
        g.repeat("@236", "@235", 1, 2147483647);
        g.repeat("@239", "@238", 0, 2147483647);
        g.repeat("@242", "@241", 0, 1);
        g.repeat("@264", "@263", 0, 2147483647);
        g.repeat("@271", "@270", 0, 2147483647);
        ...
        g.sequence("@128", "@127", "SP", "expression", "WS");
        ...
        g.sequence("@237", "@236", "DIGIT");
        g.sequence("@247", "@244", "@246");
        g.sequence("@258", "DIGIT", "DIGIT", "DIGIT", "DIGIT", "DIGIT");
        g.sequence("@270", "@268", "@269");
        g.sequence("@38", "WS", "@37", "WS", "label");
        g.sequence("@40", "label", "@39");
        g.sequence("@78", "@77", "SP");
        g.sequence("@9", "WS", "@8", "WS", "enum_constant");
        g.sequence("DIGITS", "DIGIT", "@239");
        g.sequence("ESCAPE_SEQUENCE", "@249", "ESCAPE_CHAR");
        g.sequence("EXPONENT", "@240", "@242", "DIGITS");
        g.sequence("ID", "@232", "@234");
        g.sequence("MULTI_LINE_COMMENT", "@266", "@271", "@272", "WS");
        g.sequence("SEMICOLON", "@231", "WS");
        g.sequence("SINGLE_LINE_COMMENT", "@262", "@264", "@265");
        ...
        g.sequence("add_operation", "@106", "WS", "p6_operand");
        g.sequence("and_operation", "@93", "WS", "p3_operand");
        ...
        g.sequence("big_decimal_value", "@224", "DIGITS", "@225", "DIGITS", "EXPONENT_OPT", "WS", "@226", "WS");
        g.sequence("big_integer_datum", "big_integer_value");
        g.sequence("big_integer_value", "@214", "DIGITS", "@215", "WS");
        ...
        g.sequence("byte_value", "@203", "DIGITS", "@204", "WS");
        g.sequence("call_method_expression", "PS", "@134", "SP", "WS", "p8_operand", "WS", "p8_operation", "WS");
        g.sequence("call_static_method_expression", "PS", "@137", "WS", "static_member_access", "WS", "argument_list", "WS");
        g.sequence("char_datum", "char_value");
        g.sequence("class_datum", "class_value", "WS");
        g.sequence("class_value", "@228", "SP", "WS", "type", "WS");
        g.sequence("concat_operation", "@105", "WS", "p5_operand");
        ...
        g.sequence("dispatch_expression", "PS", "@132", "SP", "WS", "name", "WS", "argument_list", "WS");
        g.sequence("divide_operation", "@108", "WS", "p7_operand");
        ...
        g.sequence("double_value", "@221", "DIGITS", "@222", "DIGITS", "EXPONENT_OPT", "WS");
        ...
        g.sequence("equals_operation", "@99", "WS", "p4_operand");
        ...
        g.sequence("float_value", "@217", "DIGITS", "@218", "DIGITS", "EXPONENT_OPT", "@219", "WS");
        ...
        g.sequence("get_field_expression", "PS", "@138", "SP", "WS", "instance_member_access", "WS");
        g.sequence("get_static_expression", "PS", "@141", "SP", "WS", "static_member_access", "WS");
        g.sequence("goto_statement", "PS", "@30", "SP", "WS", "label", "WS", "SEMICOLON");
        g.sequence("greater_operation", "@103", "WS", "p4_operand");
        g.sequence("greater_or_equals_operation", "@101", "WS", "p4_operand");
        g.sequence("identity_equals_operation", "@97", "WS", "p4_operand");
        g.sequence("identity_not_equals_operation", "@98", "WS", "p4_operand");
        g.sequence("if_case", "@25", "WS", "conditional_case", "WS");
        g.sequence("if_statement", "PS", "if_case", "elif_cases_opt", "WS", "else_case_opt", "WS");
        g.sequence("implies_operation", "@96", "WS", "p3_operand");
        ...
        g.sequence("instanceof_expression", "PS", "@144", "SP", "WS", "expression", "WS", "@145", "WS", "type", "WS");
        g.sequence("int_datum", "int_value");
        g.sequence("int_value", "@209", "DIGITS", "WS");
        ...
        g.sequence("less_operation", "@104", "WS", "p4_operand");
        g.sequence("less_or_equals_operation", "@102", "WS", "p4_operand");
        g.sequence("let_statement", "PS", "@79", "WS", "variable", "WS", "@80", "WS", "expression", "WS", "SEMICOLON");
        g.sequence("list_comprehension_body", "expression", "WS", "@124", "SP", "variable", "WS", "@125", "WS", "type", "WS", "@126", "SP", "expression", "WS", "if_opt", "WS");
        g.sequence("list_comprehension_expression", "PS", "@122", "WS", "list_comprehension_body", "WS", "@123", "WS");
        g.sequence("list_expression", "PS", "@129", "WS", "arguments", "WS", "@130", "WS");
        g.sequence("literal_char_value", "@198", "@199", "@200", "WS");
        g.sequence("locals_expression", "PS", "@116", "WS", "@117", "WS", "@118", "WS");
        g.sequence("long_datum", "long_value");
        g.sequence("long_value", "@211", "DIGITS", "@212", "WS");
        ...
        g.sequence("modulo_operation", "@109", "WS", "p7_operand");
        g.sequence("multiply_operation", "@110", "WS", "p7_operand");
        g.sequence("name", "name_id", "WS");
        g.sequence("name_id", "ID");
        g.sequence("name_of_named_module", "name");
        g.sequence("namespace_explicit", "PS", "@166");
        g.sequence("negate_operation", "@112", "WS", "p8", "WS");
        g.sequence("nested_expression", "@114", "WS", "expression", "WS", "@115", "WS");
        g.sequence("new_expression", "PS", "@133", "SP", "WS", "type", "WS", "argument_list", "WS");
        g.sequence("nop_statement", "PS", "@24", "SEMICOLON");
        g.sequence("not_equals_operation", "@100", "WS", "p4_operand");
        g.sequence("not_operation", "@113", "WS", "p8", "WS");
        g.sequence("null_coalescing_operation", "@92", "WS", "p2_operand");
        g.sequence("null_datum", "null_value", "WS");
        g.sequence("null_value", "@229", "@230", "WS");
        g.sequence("numeric_char_value", "DIGITS", "@201", "WS");
        g.sequence("or_operation", "@94", "WS", "p3_operand");
        ...
        g.sequence("p8_operation", "WS", "@111", "WS", "name", "WS", "argument_list", "WS");
        ...
        g.sequence("progn_expression", "PS", "@131", "WS", "argument_list", "WS");
        ...
        g.sequence("set_field_expression", "PS", "@139", "SP", "WS", "instance_member_access", "@140", "WS", "expression", "WS");
        g.sequence("set_static_expression", "PS", "@142", "SP", "WS", "static_member_access", "WS", "@143", "WS", "expression", "WS");
        g.sequence("short_datum", "short_value");
        g.sequence("short_value", "@206", "DIGITS", "@207", "WS");
        ...
        g.sequence("subtract_operation", "@107", "WS", "p6_operand");
        ...
        g.sequence("ternary_conditional_expression", "PS", "WS", "@119", "SP", "WS", "condition", "WS", "@120", "SP", "WS", "expression", "@121", "SP", "WS", "expression", "WS");
        ...
        g.sequence("verbatim_string_value", "@227", "WS", "STRING_LITERAL", "WS");
        ...
        g.sequence("xor_operation", "@95", "WS", "p3_operand");
        g.str("@0", "module");
        g.str("@1", "in");
        g.str("@100", "!=");
        g.str("@101", ">=");
