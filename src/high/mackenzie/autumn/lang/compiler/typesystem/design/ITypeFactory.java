...
public interface ITypeFactory 
{
     ...
     */
    public IArrayType getArrayType(IElementType element, int dimensions);
    
    /**
     * This method finds and returns a type, given its <code>java.lang.Class</code> representation. 
     * 
