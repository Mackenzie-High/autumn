        ...
        implements ICompiler
{
     ...
     *
     * @return the aforedescribed method; or null, if no create() method is needed.
     */
    protected abstract IMethod typeofCreate();
    ...
    private void finishTypeInitialization()
    {
        ...
        /**
         * Add the type of the static create() method.
         */
        final IMethod create = typeofCreate();
