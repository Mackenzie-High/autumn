        ...
        extends ExpressionCodeGenerator
{
    ...
    {
        final MemberToHandler mapping = program.symbols.setters.get(object);

        // Generated Bytecode:
        //
        // ALOAD owner                                                      - Load the prototype object.
        // LDC name                                                         - Load the name of the property.
        // INVOKESTATIC module.instance()                                   - Get the singleton instance of the module.
        ...
        code.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
                                    Utils.internalName(mapping.handler().getOwner()),
                                    "instance",
                                    "()" + mapping.handler().getOwner().getDescriptor()));

        code.add(new LdcInsnNode(object.getMethod().getName()));
        ...
        function.vars.store(object.getOwner().getName());
    }

    @Override
    public void visit(final GetterStatement object)
    {
        final MemberToHandler mapping = program.symbols.getters.get(object);
    ...
    {
        final MemberToHandler mapping = program.symbols.methods.get(object);

        final String key = mapping.member().getNamePlusParameterListDescriptor();

        // Generated Bytecode:
        //
        // ALOAD owner                                                      - Load the prototype object.
        // LDC key                                                          - Load the key that identifies the method.
        // INVOKESTATIC module.instance()                                   - Get the singleton instance of the module.
        // LDC function                                                     - Load the name of the handler function.
