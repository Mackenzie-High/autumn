...
final class DispatchCompiler
{
     ...
     * @param code is the bytecode being generated by the expression.
    ...
    public void compile(final ExpressionCodeGenerator expr)
    {
        ...
        {
            generateDispatchTableEntry(function, done);
        }

        /**
         * Default Termination
         */
        generateDefaultDispatch();
        code.add(done);
    }
    ...
    private void generateDispatchTableEntry(final IMethod target,
                                            final LabelNode done)
    {
        ...
        {
            generateArgumentTest(target, skip, i);
        }

        /**
         * Since all the arguments matched, invoke the target method.
         */
        generateInvocation(target);
    ...
    private void generateArgumentTest(final IMethod target,
    ...
    private void generateInvocation(final IMethod target)
    {
        /**
    ...
    private void generateDefaultDispatch()
    {
