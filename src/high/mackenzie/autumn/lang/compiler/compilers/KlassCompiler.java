...
public final class KlassCompiler
{
                                 ...
                                 final MethodList methods)
    {
        ...
        if (most_specific_override.getOwner().equals(program.typesystem.utils.PROTOTYPE))
        {
            return false;
        }
    ...
    private MethodNode generateMethodCopyReturnsPrototype()
    {
        ...
        method.access = Opcodes.ACC_PUBLIC + Opcodes.ACC_FINAL + Opcodes.ACC_BRIDGE;
        method.name = "copy";
        method.desc = "()" + program.typesystem.utils.PROTOTYPE.getDescriptor();
        method.exceptions = ImmutableList.of();
                                ...
                                final IMethod method_type)
    {
        ...
        method.instructions.add(Utils.ldcDefault(method_type.getReturnType()));
                                      ...
                                      final IMethod target)
    {
        ...
        method.instructions.add(Utils.ldcDefault(bridge.getReturnType()));
