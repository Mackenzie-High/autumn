 ...
 *     <tr> <td> <code>variable</code> </td> <td>This is the variable that the new delegate will be assigned to.</td> </tr>
 *     <tr> <td> <code>type</code> </td> <td>This is the type of the new delegate.</td> </tr>
 ...
 * </p>
 * 
 * <p> This file was auto-generated on (Mon Mar 30 16:55:44 EDT 2015).</p>
 */
@SuppressWarnings("unchecked")
public final class DelegateStatement extends Object implements IStatement
{
     ...
     */
    public DelegateStatement setVariable(final Variable value)
    {
        final DelegateStatement result = this.copy();
     ...
     */
    public DelegateStatement setType(final TypeSpecifier value)
    {
        final DelegateStatement result = this.copy();
        result.type = value;
        return result;
     ...
     */
    public DelegateStatement setOwner(final TypeSpecifier value)
    {
        final DelegateStatement result = this.copy();
        result.owner = value;
        return result;
     ...
     */
    public DelegateStatement setMethod(final Name value)
    {
        final DelegateStatement result = this.copy();
        result.method = value;
        return result;
     ...
     */
    public DelegateStatement setLocation(final SourceLocation value)
    {
        final DelegateStatement result = this.copy();
     ...
     */
    public static DelegateStatement create(Variable variable, TypeSpecifier type, TypeSpecifier owner, Name method, SourceLocation location)
    {
        DelegateStatement object = new DelegateStatement();
     ...
     */
    public DelegateStatement copy()
    {
        final DelegateStatement result = new DelegateStatement();
