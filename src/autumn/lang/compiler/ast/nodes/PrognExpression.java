 ...
 *     <tr> <td> <code>elements</code> </td> <td>These are the expressions in the sequence.</td> </tr>
...
public final class PrognExpression extends Object implements IExpression
{
    private ConstructList<IExpression> elements = new ConstructList();
     ...
     */
    public PrognExpression setElements(final ConstructList<IExpression> value)
    {
        final PrognExpression result = this.copy();
     ...
     */
    public ConstructList<IExpression> getElements()
    {
        final ConstructList<IExpression> value = this.elements;
        return value;
    }
     ...
     */
    public PrognExpression setLocation(final SourceLocation value)
    {
        final PrognExpression result = this.copy();
     ...
     */
    public static PrognExpression create(ConstructList<IExpression> elements, SourceLocation location)
    {
        PrognExpression object = new PrognExpression();
     ...
     */
    public PrognExpression copy()
    {
        final PrognExpression result = new PrognExpression();
