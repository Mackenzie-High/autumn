...
public final class LocalsExpression extends Object implements IExpression
{
     ...
     */
    public LocalsExpression setLocation(final SourceLocation value)
    {
        final LocalsExpression result = this.copy();
     ...
     */
    public static LocalsExpression create(SourceLocation location)
    {
        LocalsExpression object = new LocalsExpression();
     ...
     */
    public LocalsExpression copy()
    {
        final LocalsExpression result = new LocalsExpression();
