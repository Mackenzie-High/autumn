...
public final class EqualsOperation extends Object implements IBinaryOperation
{
     ...
     */
    public EqualsOperation setLeftOperand(final IExpression value)
    {
        final EqualsOperation result = this.copy();
     ...
     */
    public EqualsOperation setRightOperand(final IExpression value)
    {
        final EqualsOperation result = this.copy();
     ...
     */
    public EqualsOperation setLocation(final SourceLocation value)
    {
        final EqualsOperation result = this.copy();
     ...
     */
    public EqualsOperation copy()
    {
        final EqualsOperation result = new EqualsOperation();
