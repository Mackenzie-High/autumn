...
public final class BreakStatement extends Object implements IStatement
{
     ...
     */
    public BreakStatement setLocation(final SourceLocation value)
    {
        final BreakStatement result = this.copy();
     ...
     */
    public static BreakStatement create(SourceLocation location)
    {
    ...
    {
        final BreakStatement result = new BreakStatement();
