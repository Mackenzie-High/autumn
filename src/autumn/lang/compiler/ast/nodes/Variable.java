 ...
 *     <tr> <td> <code>name</code> </td> <td>This is the name of the variable. The name must be a case-sensitive series of letters, underscores, and/or digits that does not start with a digit.</td> </tr>
...
public final class Variable extends Object implements IConstruct
{
    private String name;
     ...
     */
    public Variable setName(final String value)
    {
        final Variable result = this.copy();
        result.name = value;
        return result;
    }
     ...
     */
    public Variable setLocation(final SourceLocation value)
    {
        final Variable result = this.copy();
     ...
     */
    public static Variable create(String name, SourceLocation location)
    {
