...
public final class DivideOperation extends Object implements IBinaryOperation
{
     ...
     */
    public DivideOperation setLeftOperand(final IExpression value)
    {
        final DivideOperation result = this.copy();
     ...
     */
    public DivideOperation setRightOperand(final IExpression value)
    {
        final DivideOperation result = this.copy();
     ...
     */
    public DivideOperation setLocation(final SourceLocation value)
    {
        final DivideOperation result = this.copy();
     ...
     */
    public static DivideOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
     ...
     */
    public DivideOperation copy()
    {
        final DivideOperation result = new DivideOperation();
