...
public final class DoUntilStatement extends Object implements IStatement
{
     ...
     */
    public DoUntilStatement setCondition(final IExpression value)
    {
        final DoUntilStatement result = this.copy();
     ...
     */
    public DoUntilStatement setBody(final SequenceStatement value)
    {
        final DoUntilStatement result = this.copy();
        result.body = value;
        return result;
     ...
     */
    public DoUntilStatement setLocation(final SourceLocation value)
    {
        final DoUntilStatement result = this.copy();
     ...
     */
    public static DoUntilStatement create(IExpression condition, SequenceStatement body, SourceLocation location)
    {
        DoUntilStatement object = new DoUntilStatement();
     ...
     */
    public DoUntilStatement copy()
    {
        final DoUntilStatement result = new DoUntilStatement();
