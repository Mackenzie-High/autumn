...
public final class NegateOperation extends Object implements IUnaryOperation
{
     ...
     */
    public NegateOperation setOperand(final IExpression value)
    {
        final NegateOperation result = this.copy();
     ...
     */
    public NegateOperation setLocation(final SourceLocation value)
    {
        final NegateOperation result = this.copy();
    ...
    {
        NegateOperation object = new NegateOperation();
    ...
    {
        final NegateOperation result = new NegateOperation();
