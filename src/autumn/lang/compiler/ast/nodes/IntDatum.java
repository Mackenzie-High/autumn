...
public final class IntDatum extends Object implements IDatum
{
     ...
     */
    public IntDatum setValue(final IntLiteral value)
    {
        final IntDatum result = this.copy();
        result.value = value;
        return result;
    }
    ...
    {
        final IntLiteral value = this.value;
        return value;
    }
     ...
     */
    public IntDatum setLocation(final SourceLocation value)
    {
        final IntDatum result = this.copy();
     ...
     */
    public static IntDatum create(IntLiteral value, SourceLocation location)
    {
        IntDatum object = new IntDatum();
     ...
     */
    public IntDatum copy()
    {
        final IntDatum result = new IntDatum();
