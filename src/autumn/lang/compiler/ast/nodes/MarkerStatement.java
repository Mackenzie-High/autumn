 ...
 *     <tr> <td> <code>label</code> </td> <td>This label identifies the marked location.</td> </tr>
...
public final class MarkerStatement extends Object implements IStatement
{
    private Label label;
     ...
     * Setter.
     * 
     * @param value is the new value of property <code>label</code>.
     * @return a copy of this object with property <code>label</code> set to value.
     */
    public MarkerStatement setLabel(final Label value)
    {
        final MarkerStatement result = this.copy();
        result.label = value;
        return result;
    }
     ...
     * Getter.
     * 
     * @return the value of property <code>label</code>.
     */
    public Label getLabel()
    {
        final Label value = this.label;
        return value;
    }
     ...
     */
    public MarkerStatement setLocation(final SourceLocation value)
    {
        final MarkerStatement result = this.copy();
     ...
     * 
     * @param label is the value for property <code>label</code>.
     * @param location is the value for property <code>location</code>.
     * @return a new instance of this class.
     */
    public static MarkerStatement create(Label label, SourceLocation location)
    {
        MarkerStatement object = new MarkerStatement();
        object = object.setLabel(label);
     ...
     */
    public MarkerStatement copy()
    {
        final MarkerStatement result = new MarkerStatement();
