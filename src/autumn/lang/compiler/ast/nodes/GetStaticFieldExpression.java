...
public final class GetStaticFieldExpression extends Object implements IExpression
{
     ...
     */
    public GetStaticFieldExpression setOwner(final TypeSpecifier value)
    {
        final GetStaticFieldExpression result = this.copy();
        result.owner = value;
        return result;
    }
     ...
     */
    public GetStaticFieldExpression setName(final Name value)
    {
        final GetStaticFieldExpression result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public GetStaticFieldExpression setLocation(final SourceLocation value)
    {
        final GetStaticFieldExpression result = this.copy();
     ...
     */
    public static GetStaticFieldExpression create(TypeSpecifier owner, Name name, SourceLocation location)
    {
        GetStaticFieldExpression object = new GetStaticFieldExpression();
     ...
     */
    public GetStaticFieldExpression copy()
    {
        final GetStaticFieldExpression result = new GetStaticFieldExpression();
