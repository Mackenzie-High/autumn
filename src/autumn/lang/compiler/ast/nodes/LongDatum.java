...
public final class LongDatum extends Object implements IDatum
{
    private LongLiteral value;
     ...
     */
    public LongDatum setValue(final LongLiteral value)
    {
        final LongDatum result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public LongLiteral getValue()
    {
        final LongLiteral value = this.value;
        return value;
    }
     ...
     */
    public LongDatum setLocation(final SourceLocation value)
    {
        final LongDatum result = this.copy();
     ...
     */
    public static LongDatum create(LongLiteral value, SourceLocation location)
    {
        LongDatum object = new LongDatum();
     ...
     */
    public LongDatum copy()
    {
        final LongDatum result = new LongDatum();
