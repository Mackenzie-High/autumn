...
public final class AssumeStatement extends Object implements IStatement
{
     ...
     */
    public AssumeStatement setCondition(final IExpression value)
    {
        final AssumeStatement result = this.copy();
     ...
     */
    public AssumeStatement setMessage(final IExpression value)
    {
        final AssumeStatement result = this.copy();
     ...
     */
    public AssumeStatement setLocation(final SourceLocation value)
    {
        final AssumeStatement result = this.copy();
     ...
     */
    public static AssumeStatement create(IExpression condition, IExpression message, SourceLocation location)
    {
        AssumeStatement object = new AssumeStatement();
     ...
     */
    public AssumeStatement copy()
    {
        final AssumeStatement result = new AssumeStatement();
