...
public final class LessThanOrEqualsOperation extends Object implements IBinaryOperation
{
     ...
     */
    public LessThanOrEqualsOperation setLeftOperand(final IExpression value)
    {
        final LessThanOrEqualsOperation result = this.copy();
     ...
     */
    public LessThanOrEqualsOperation setRightOperand(final IExpression value)
    {
        final LessThanOrEqualsOperation result = this.copy();
     ...
     */
    public LessThanOrEqualsOperation setLocation(final SourceLocation value)
    {
        final LessThanOrEqualsOperation result = this.copy();
     ...
     */
    public static LessThanOrEqualsOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        LessThanOrEqualsOperation object = new LessThanOrEqualsOperation();
     ...
     */
    public LessThanOrEqualsOperation copy()
    {
        final LessThanOrEqualsOperation result = new LessThanOrEqualsOperation();
