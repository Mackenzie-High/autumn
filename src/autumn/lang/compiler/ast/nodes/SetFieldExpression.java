...
public final class SetFieldExpression extends Object implements IExpression
{
     ...
     */
    public SetFieldExpression setOwner(final IExpression value)
    {
        final SetFieldExpression result = this.copy();
        result.owner = value;
        return result;
    }
     ...
     */
    public SetFieldExpression setName(final Name value)
    {
        final SetFieldExpression result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public SetFieldExpression setValue(final IExpression value)
    {
        final SetFieldExpression result = this.copy();
        result.value = value;
        return result;
     ...
     */
    public SetFieldExpression setLocation(final SourceLocation value)
    {
        final SetFieldExpression result = this.copy();
     ...
     */
    public static SetFieldExpression create(IExpression owner, Name name, IExpression value, SourceLocation location)
    {
        SetFieldExpression object = new SetFieldExpression();
     ...
     */
    public SetFieldExpression copy()
    {
        final SetFieldExpression result = new SetFieldExpression();
