...
public final class ContinueStatement extends Object implements IStatement
{
     ...
     */
    public ContinueStatement setLocation(final SourceLocation value)
    {
        final ContinueStatement result = this.copy();
     ...
     */
    public static ContinueStatement create(SourceLocation location)
    {
    ...
    {
        final ContinueStatement result = new ContinueStatement();
