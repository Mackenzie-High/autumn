 ...
 *     <tr> <td> <code>operand</code> </td> <td>This expression produces the operation's only operand.</td> </tr>
...
public final class NotOperation extends Object implements IUnaryOperation
{
     ...
     * Setter.
     * 
     * @param value is the new value of property <code>operand</code>.
     * @return a copy of this object with property <code>operand</code> set to value.
     */
    public NotOperation setOperand(final IExpression value)
    {
        final NotOperation result = this.copy();
     ...
     * Getter.
     * 
     * @return the value of property <code>operand</code>.
     */
    public IExpression getOperand()
    {
        final IExpression value = this.operand;
        return value;
    }
     ...
     */
    public NotOperation setLocation(final SourceLocation value)
    {
        final NotOperation result = this.copy();
     ...
     * 
     * @param operand is the value for property <code>operand</code>.
     * @param location is the value for property <code>location</code>.
     * @return a new instance of this class.
     */
    public static NotOperation create(IExpression operand, SourceLocation location)
    {
        NotOperation object = new NotOperation();
        object = object.setOperand(operand);
     ...
     */
    public NotOperation copy()
    {
        final NotOperation result = new NotOperation();
    ...
    public Map<String, Object> toMap()
    {
        ...
        map.put("operand", this.getOperand());
