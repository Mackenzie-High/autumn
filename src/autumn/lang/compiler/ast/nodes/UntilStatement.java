...
public final class UntilStatement extends Object implements IStatement
{
     ...
     */
    public UntilStatement setCondition(final IExpression value)
    {
        final UntilStatement result = this.copy();
     ...
     */
    public UntilStatement setBody(final SequenceStatement value)
    {
        final UntilStatement result = this.copy();
        result.body = value;
        return result;
     ...
     */
    public UntilStatement setLocation(final SourceLocation value)
    {
        final UntilStatement result = this.copy();
     ...
     */
    public static UntilStatement create(IExpression condition, SequenceStatement body, SourceLocation location)
    {
        UntilStatement object = new UntilStatement();
     ...
     */
    public UntilStatement copy()
    {
        final UntilStatement result = new UntilStatement();
