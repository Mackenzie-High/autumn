 ...
 *     <tr> <td> <code>type</code> </td> <td>This is the type whose <code>java.lang.Class</code> representation is represented by this datum.</td> </tr>
...
public final class ClassDatum extends Object implements IExpression
{
     ...
     */
    public ClassDatum setType(final TypeSpecifier value)
    {
        final ClassDatum result = this.copy();
        result.type = value;
        return result;
    }
     ...
     */
    public ClassDatum setLocation(final SourceLocation value)
    {
        final ClassDatum result = this.copy();
     ...
     */
    public static ClassDatum create(TypeSpecifier type, SourceLocation location)
    {
        ClassDatum object = new ClassDatum();
     ...
     */
    public ClassDatum copy()
    {
        final ClassDatum result = new ClassDatum();
