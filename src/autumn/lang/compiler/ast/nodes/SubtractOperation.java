...
public final class SubtractOperation extends Object implements IBinaryOperation
{
     ...
     */
    public SubtractOperation setLeftOperand(final IExpression value)
    {
        final SubtractOperation result = this.copy();
     ...
     */
    public SubtractOperation setRightOperand(final IExpression value)
    {
        final SubtractOperation result = this.copy();
     ...
     */
    public SubtractOperation setLocation(final SourceLocation value)
    {
        final SubtractOperation result = this.copy();
     ...
     */
    public static SubtractOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
     ...
     */
    public SubtractOperation copy()
    {
        final SubtractOperation result = new SubtractOperation();
