...
/**
 * An instance of this class is an AST node that represents the short-circuit logical-OR operator.
 * 
 * <p> 
 * <table border="1">
...
public final class ShortCircuitOrOperation extends Object implements IBinaryOperation
{
     ...
     */
    public ShortCircuitOrOperation setLeftOperand(final IExpression value)
    {
        final ShortCircuitOrOperation result = this.copy();
     ...
     */
    public ShortCircuitOrOperation setRightOperand(final IExpression value)
    {
        final ShortCircuitOrOperation result = this.copy();
     ...
     */
    public ShortCircuitOrOperation setLocation(final SourceLocation value)
    {
        final ShortCircuitOrOperation result = this.copy();
     ...
     */
    public static ShortCircuitOrOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        ShortCircuitOrOperation object = new ShortCircuitOrOperation();
     ...
     */
    public ShortCircuitOrOperation copy()
    {
        final ShortCircuitOrOperation result = new ShortCircuitOrOperation();
