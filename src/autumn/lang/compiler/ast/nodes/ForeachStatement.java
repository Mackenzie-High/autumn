 ...
 *     <tr> <td> <code>type</code> </td> <td>This is the type of the control variable.</td> </tr>
 *     <tr> <td> <code>iterable</code> </td> <td>This expression produces the iterable object to iterate over.</td> </tr>
...
public final class ForeachStatement extends Object implements IStatement
{
     ...
     */
    public ForeachStatement setVariable(final Variable value)
    {
        final ForeachStatement result = this.copy();
     ...
     */
    public ForeachStatement setType(final TypeSpecifier value)
    {
        final ForeachStatement result = this.copy();
        result.type = value;
        return result;
     ...
     */
    public ForeachStatement setIterable(final IExpression value)
    {
        final ForeachStatement result = this.copy();
     ...
     */
    public ForeachStatement setBody(final SequenceStatement value)
    {
        final ForeachStatement result = this.copy();
        result.body = value;
        return result;
     ...
     */
    public ForeachStatement setLocation(final SourceLocation value)
    {
        final ForeachStatement result = this.copy();
    ...
    {
        final ForeachStatement result = new ForeachStatement();
