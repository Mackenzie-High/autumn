...
public final class GreaterThanOperation extends Object implements IBinaryOperation
{
     ...
     */
    public static GreaterThanOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        GreaterThanOperation object = new GreaterThanOperation();
