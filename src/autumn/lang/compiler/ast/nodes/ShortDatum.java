...
public final class ShortDatum extends Object implements IDatum
{
    private ShortLiteral value;
     ...
     */
    public ShortDatum setValue(final ShortLiteral value)
    {
        final ShortDatum result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public ShortLiteral getValue()
    {
        final ShortLiteral value = this.value;
        return value;
    }
     ...
     */
    public ShortDatum setLocation(final SourceLocation value)
    {
        final ShortDatum result = this.copy();
     ...
     */
    public static ShortDatum create(ShortLiteral value, SourceLocation location)
    {
        ShortDatum object = new ShortDatum();
     ...
     */
    public ShortDatum copy()
    {
        final ShortDatum result = new ShortDatum();
