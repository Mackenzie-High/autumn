...
public final class FloatDatum extends Object implements IDatum
{
    private FloatLiteral value;
     ...
     */
    public FloatDatum setValue(final FloatLiteral value)
    {
        final FloatDatum result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public FloatLiteral getValue()
    {
        final FloatLiteral value = this.value;
        return value;
    }
     ...
     */
    public FloatDatum setLocation(final SourceLocation value)
    {
        final FloatDatum result = this.copy();
     ...
     */
    public static FloatDatum create(FloatLiteral value, SourceLocation location)
    {
        FloatDatum object = new FloatDatum();
     ...
     */
    public FloatDatum copy()
    {
        final FloatDatum result = new FloatDatum();
