 ...
 *     <tr> <td> <code>owner</code> </td> <td>This is the type that declares the method to invoke.</td> </tr>
...
public final class CallStaticMethodExpression extends Object implements IExpression
{
     ...
     */
    public CallStaticMethodExpression setOwner(final TypeSpecifier value)
    {
        final CallStaticMethodExpression result = this.copy();
        result.owner = value;
        return result;
    }
     ...
     */
    public CallStaticMethodExpression setName(final Name value)
    {
        final CallStaticMethodExpression result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public CallStaticMethodExpression setArguments(final ConstructList<IExpression> value)
    {
        final CallStaticMethodExpression result = this.copy();
     ...
     */
    public CallStaticMethodExpression setLocation(final SourceLocation value)
    {
        final CallStaticMethodExpression result = this.copy();
     ...
     */
    public CallStaticMethodExpression copy()
    {
        final CallStaticMethodExpression result = new CallStaticMethodExpression();
