...
/**
 * An instance of this class is an AST node that represents a enum-case in switch-statement.
 * 
 * <p> 
 * <table border="1">
 *     <tr> <td> <b>Property Name</b> </td> <td> <b>Property Description</b> </td> </tr>
 *     <tr> <td> <code>constant</code> </td> <td>This is the name of the enum-constant.</td> </tr>
 *     <tr> <td> <code>body</code> </td> <td>This is the statement that may be executed.</td> </tr>
...
public final class EnumCase extends Object implements IConstruct
{
     ...
     * Setter.
     * 
     * @param value is the new value of property <code>constant</code>.
     * @return a copy of this object with property <code>constant</code> set to value.
     */
    public EnumCase setConstant(final Name value)
    {
        final EnumCase result = this.copy();
     ...
     * Getter.
     * 
     * @return the value of property <code>constant</code>.
     */
    public Name getConstant()
    {
        final Name value = this.constant;
        return value;
    }
     ...
     */
    public EnumCase setBody(final SequenceStatement value)
    {
        final EnumCase result = this.copy();
        result.body = value;
        return result;
     ...
     */
    public EnumCase setLocation(final SourceLocation value)
    {
        final EnumCase result = this.copy();
     ...
     */
    public EnumCase copy()
    {
        final EnumCase result = new EnumCase();
    ...
    public Map<String, Object> toMap()
    {
        ...
        map.put("constant", this.getConstant());
