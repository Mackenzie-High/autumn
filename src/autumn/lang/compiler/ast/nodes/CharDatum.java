...
public final class CharDatum extends Object implements IDatum
{
    private CharLiteral value;
     ...
     */
    public CharDatum setValue(final CharLiteral value)
    {
        final CharDatum result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public CharLiteral getValue()
    {
        final CharLiteral value = this.value;
        return value;
    }
     ...
     */
    public CharDatum setLocation(final SourceLocation value)
    {
        final CharDatum result = this.copy();
     ...
     */
    public static CharDatum create(CharLiteral value, SourceLocation location)
    {
        CharDatum object = new CharDatum();
     ...
     */
    public CharDatum copy()
    {
        final CharDatum result = new CharDatum();
