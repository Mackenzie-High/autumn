...
public final class WhenStatement extends Object implements IStatement
{
     ...
     */
    public WhenStatement setCondition(final IExpression value)
    {
        final WhenStatement result = this.copy();
     ...
     */
    public WhenStatement setBody(final IStatement value)
    {
        final WhenStatement result = this.copy();
        result.body = value;
        return result;
    ...
    {
        final IStatement value = this.body;
        return value;
    }
     ...
     */
    public WhenStatement setLocation(final SourceLocation value)
    {
        final WhenStatement result = this.copy();
     ...
     */
    public static WhenStatement create(IExpression condition, IStatement body, SourceLocation location)
    {
        WhenStatement object = new WhenStatement();
     ...
     */
    public WhenStatement copy()
    {
        final WhenStatement result = new WhenStatement();
