...
/**
 * An instance of this class is an AST node that represents a literal linked-list data-structure.
 * 
 * <p> 
 * <table border="1">
 *     <tr> <td> <b>Property Name</b> </td> <td> <b>Property Description</b> </td> </tr>
 *     <tr> <td> <code>elements</code> </td> <td>These are the expressions that produce the elements in the list.</td> </tr>
...
public final class ListExpression extends Object implements IExpression
{
     ...
     */
    public ListExpression setElements(final ConstructList<IExpression> value)
    {
        final ListExpression result = this.copy();
     ...
     */
    public ListExpression setLocation(final SourceLocation value)
    {
        final ListExpression result = this.copy();
     ...
     */
    public static ListExpression create(ConstructList<IExpression> elements, SourceLocation location)
    {
        ListExpression object = new ListExpression();
