...
public final class ReturnValueStatement extends Object implements IStatement
{
     ...
     */
    public ReturnValueStatement setValue(final IExpression value)
    {
        final ReturnValueStatement result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public ReturnValueStatement setLocation(final SourceLocation value)
    {
        final ReturnValueStatement result = this.copy();
     ...
     */
    public static ReturnValueStatement create(IExpression value, SourceLocation location)
    {
        ReturnValueStatement object = new ReturnValueStatement();
     ...
     */
    public ReturnValueStatement copy()
    {
        final ReturnValueStatement result = new ReturnValueStatement();
