...
public final class IdentityNotEqualsOperation extends Object implements IBinaryOperation
{
     ...
     */
    public IdentityNotEqualsOperation setLeftOperand(final IExpression value)
    {
        final IdentityNotEqualsOperation result = this.copy();
     ...
     */
    public IdentityNotEqualsOperation setRightOperand(final IExpression value)
    {
        final IdentityNotEqualsOperation result = this.copy();
     ...
     */
    public IdentityNotEqualsOperation setLocation(final SourceLocation value)
    {
        final IdentityNotEqualsOperation result = this.copy();
     ...
     */
    public static IdentityNotEqualsOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        IdentityNotEqualsOperation object = new IdentityNotEqualsOperation();
     ...
     */
    public IdentityNotEqualsOperation copy()
    {
        final IdentityNotEqualsOperation result = new IdentityNotEqualsOperation();
