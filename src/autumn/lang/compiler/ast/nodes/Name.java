...
/**
 * An instance of this class is an AST node that represents a simple name. A simple name must be a case-sensitive series of letters, underscores, and/or digits that does not start with a digit.
 * 
 * <p> 
 * <table border="1">
 *     <tr> <td> <b>Property Name</b> </td> <td> <b>Property Description</b> </td> </tr>
 *     <tr> <td> <code>name</code> </td> <td>This is the name as a string.</td> </tr>
...
public final class Name extends Object implements IConstruct
{
    private String name;
     ...
     */
    public Name setName(final String value)
    {
        final Name result = this.copy();
        result.name = value;
        return result;
    }
     ...
     */
    public Name setLocation(final SourceLocation value)
    {
        final Name result = this.copy();
     ...
     */
    public static Name create(String name, SourceLocation location)
    {
