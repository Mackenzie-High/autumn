 ...
 *     <tr> <td> <code>parameters</code> </td> <td>These are the formal-parameters themselves.</td> </tr>
...
{
    private ConstructList<FormalParameter> parameters = new ConstructList();
     ...
     */
    public FormalParameterList setParameters(final ConstructList<FormalParameter> value)
    {
        final FormalParameterList result = this.copy();
     ...
     */
    public ConstructList<FormalParameter> getParameters()
    {
        final ConstructList<FormalParameter> value = this.parameters;
        return value;
    }
     ...
     */
    public FormalParameterList setLocation(final SourceLocation value)
    {
        final FormalParameterList result = this.copy();
     ...
     */
    public FormalParameterList copy()
    {
        final FormalParameterList result = new FormalParameterList();
