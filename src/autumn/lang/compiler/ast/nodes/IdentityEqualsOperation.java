...
public final class IdentityEqualsOperation extends Object implements IBinaryOperation
{
     ...
     */
    public IdentityEqualsOperation setLeftOperand(final IExpression value)
    {
        final IdentityEqualsOperation result = this.copy();
     ...
     */
    public IdentityEqualsOperation setRightOperand(final IExpression value)
    {
        final IdentityEqualsOperation result = this.copy();
     ...
     */
    public IdentityEqualsOperation setLocation(final SourceLocation value)
    {
        final IdentityEqualsOperation result = this.copy();
     ...
     */
    public static IdentityEqualsOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        IdentityEqualsOperation object = new IdentityEqualsOperation();
     ...
     */
    public IdentityEqualsOperation copy()
    {
        final IdentityEqualsOperation result = new IdentityEqualsOperation();
