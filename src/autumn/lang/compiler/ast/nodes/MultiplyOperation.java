...
public final class MultiplyOperation extends Object implements IBinaryOperation
{
     ...
     */
    public MultiplyOperation setLeftOperand(final IExpression value)
    {
        final MultiplyOperation result = this.copy();
     ...
     */
    public MultiplyOperation setRightOperand(final IExpression value)
    {
        final MultiplyOperation result = this.copy();
     ...
     */
    public MultiplyOperation setLocation(final SourceLocation value)
    {
        final MultiplyOperation result = this.copy();
     ...
     */
    public static MultiplyOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
     ...
     */
    public MultiplyOperation copy()
    {
        final MultiplyOperation result = new MultiplyOperation();
