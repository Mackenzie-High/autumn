...
public final class ImpliesOperation extends Object implements IBinaryOperation
{
     ...
     */
    public ImpliesOperation setLeftOperand(final IExpression value)
    {
        final ImpliesOperation result = this.copy();
     ...
     */
    public ImpliesOperation setRightOperand(final IExpression value)
    {
        final ImpliesOperation result = this.copy();
     ...
     */
    public ImpliesOperation setLocation(final SourceLocation value)
    {
        final ImpliesOperation result = this.copy();
     ...
     */
    public static ImpliesOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        ImpliesOperation object = new ImpliesOperation();
     ...
     */
    public ImpliesOperation copy()
    {
        final ImpliesOperation result = new ImpliesOperation();
