 ...
 *     <tr> <td> <code>comment</code> </td> <td>This is the doc-comment applied directly to the method.</td> </tr>
...
public final class DesignMethod extends Object implements IAnnotated, IDocumented
{
     ...
     */
    public DesignMethod setComment(final DocComment value)
    {
     ...
     */
    public static DesignMethod create(DocComment comment, AnnotationList annotations, Name name, FormalParameterList parameters, TypeSpecifier return_type, SourceLocation location)
    {
