...
public final class TupleDefinition extends Object implements IAnnotated, IDocumented
{
     ...
     */
    public TupleDefinition setComment(final DocComment value)
    {
     ...
     */
    public TupleDefinition setAnnotations(final AnnotationList value)
    {
        final TupleDefinition result = this.copy();
     ...
     */
    public TupleDefinition setName(final Name value)
    {
        final TupleDefinition result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public TupleDefinition setLocation(final SourceLocation value)
    {
        final TupleDefinition result = this.copy();
    ...
    {
        final TupleDefinition result = new TupleDefinition();
