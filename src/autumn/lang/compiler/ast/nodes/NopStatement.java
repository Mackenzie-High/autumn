...
public final class NopStatement extends Object implements IStatement
{
     ...
     */
    public NopStatement setLocation(final SourceLocation value)
    {
        final NopStatement result = this.copy();
     ...
     */
    public static NopStatement create(SourceLocation location)
    {
        NopStatement object = new NopStatement();
     ...
     */
    public NopStatement copy()
    {
        final NopStatement result = new NopStatement();
