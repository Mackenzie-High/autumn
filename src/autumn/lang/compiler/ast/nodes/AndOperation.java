...
public final class AndOperation extends Object implements IBinaryOperation
{
     ...
     */
    public AndOperation setLeftOperand(final IExpression value)
    {
        final AndOperation result = this.copy();
     ...
     */
    public AndOperation setRightOperand(final IExpression value)
    {
        final AndOperation result = this.copy();
     ...
     */
    public AndOperation setLocation(final SourceLocation value)
    {
        final AndOperation result = this.copy();
     ...
     */
    public static AndOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        AndOperation object = new AndOperation();
    ...
    {
        final AndOperation result = new AndOperation();
