...
/**
 * An instance of this class is an AST node that represents a statement that binds the implementation of a property's getter to an object.
 * 
 * <p> 
 * <table border="1">
...
public final class GetterStatement extends Object implements IStatement
{
     ...
     */
    public GetterStatement setOwner(final Variable value)
    {
        final GetterStatement result = this.copy();
        result.owner = value;
        return result;
    }
     ...
     */
    public GetterStatement setName(final Name value)
    {
        final GetterStatement result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public GetterStatement setModule(final TypeSpecifier value)
    {
        final GetterStatement result = this.copy();
        result.module = value;
        return result;
     ...
     */
    public GetterStatement setMethod(final Name value)
    {
        final GetterStatement result = this.copy();
        result.method = value;
        return result;
     ...
     */
    public GetterStatement setLocation(final SourceLocation value)
    {
        final GetterStatement result = this.copy();
     ...
     */
    public static GetterStatement create(Variable owner, Name name, TypeSpecifier module, Name method, SourceLocation location)
    {
        GetterStatement object = new GetterStatement();
     ...
     */
    public GetterStatement copy()
    {
        final GetterStatement result = new GetterStatement();
