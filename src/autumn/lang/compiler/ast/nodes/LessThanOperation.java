...
public final class LessThanOperation extends Object implements IBinaryOperation
{
     ...
     */
    public LessThanOperation setLeftOperand(final IExpression value)
    {
        final LessThanOperation result = this.copy();
     ...
     */
    public LessThanOperation setRightOperand(final IExpression value)
    {
        final LessThanOperation result = this.copy();
     ...
     */
    public LessThanOperation setLocation(final SourceLocation value)
    {
        final LessThanOperation result = this.copy();
     ...
     */
    public static LessThanOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        LessThanOperation object = new LessThanOperation();
     ...
     */
    public LessThanOperation copy()
    {
        final LessThanOperation result = new LessThanOperation();
