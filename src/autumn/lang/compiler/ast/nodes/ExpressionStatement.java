 ...
 *     <tr> <td> <code>expression</code> </td> <td>This is the expression to evaluate.</td> </tr>
...
public final class ExpressionStatement extends Object implements IStatement
{
     ...
     * Setter.
     * 
     * @param value is the new value of property <code>expression</code>.
     * @return a copy of this object with property <code>expression</code> set to value.
     */
    public ExpressionStatement setExpression(final IExpression value)
    {
        final ExpressionStatement result = this.copy();
     ...
     * Getter.
     * 
     * @return the value of property <code>expression</code>.
     */
    public IExpression getExpression()
    {
        final IExpression value = this.expression;
        return value;
    }
     ...
     */
    public ExpressionStatement setLocation(final SourceLocation value)
    {
        final ExpressionStatement result = this.copy();
     ...
     * 
     * @param expression is the value for property <code>expression</code>.
     * @param location is the value for property <code>location</code>.
     * @return a new instance of this class.
     */
    public static ExpressionStatement create(IExpression expression, SourceLocation location)
    {
        ExpressionStatement object = new ExpressionStatement();
        object = object.setExpression(expression);
