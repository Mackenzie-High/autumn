...
/**
 * An instance of this class is an AST node that represents the short-circuit logical-AND operator.
 * 
 * <p> 
 * <table border="1">
...
public final class ShortCircuitAndOperation extends Object implements IBinaryOperation
{
     ...
     */
    public ShortCircuitAndOperation setLeftOperand(final IExpression value)
    {
        final ShortCircuitAndOperation result = this.copy();
     ...
     */
    public ShortCircuitAndOperation setRightOperand(final IExpression value)
    {
        final ShortCircuitAndOperation result = this.copy();
     ...
     */
    public ShortCircuitAndOperation setLocation(final SourceLocation value)
    {
        final ShortCircuitAndOperation result = this.copy();
     ...
     */
    public static ShortCircuitAndOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        ShortCircuitAndOperation object = new ShortCircuitAndOperation();
     ...
     */
    public ShortCircuitAndOperation copy()
    {
        final ShortCircuitAndOperation result = new ShortCircuitAndOperation();
