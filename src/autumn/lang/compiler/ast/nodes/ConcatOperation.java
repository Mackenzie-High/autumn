...
public final class ConcatOperation extends Object implements IBinaryOperation
{
     ...
     */
    public ConcatOperation setLeftOperand(final IExpression value)
    {
        final ConcatOperation result = this.copy();
     ...
     */
    public ConcatOperation setRightOperand(final IExpression value)
    {
        final ConcatOperation result = this.copy();
     ...
     */
    public ConcatOperation setLocation(final SourceLocation value)
    {
        final ConcatOperation result = this.copy();
     ...
     */
    public static ConcatOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        ConcatOperation object = new ConcatOperation();
     ...
     */
    public ConcatOperation copy()
    {
        final ConcatOperation result = new ConcatOperation();
