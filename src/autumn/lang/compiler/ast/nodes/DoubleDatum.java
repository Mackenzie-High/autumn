...
public final class DoubleDatum extends Object implements IDatum
{
     ...
     */
    public DoubleDatum setValue(final DoubleLiteral value)
    {
        final DoubleDatum result = this.copy();
        result.value = value;
        return result;
    }
    ...
    {
        final DoubleLiteral value = this.value;
        return value;
    }
     ...
     */
    public DoubleDatum setLocation(final SourceLocation value)
    {
        final DoubleDatum result = this.copy();
     ...
     */
    public static DoubleDatum create(DoubleLiteral value, SourceLocation location)
    {
        DoubleDatum object = new DoubleDatum();
     ...
     */
    public DoubleDatum copy()
    {
        final DoubleDatum result = new DoubleDatum();
