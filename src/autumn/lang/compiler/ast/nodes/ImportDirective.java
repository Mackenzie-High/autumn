 ...
 *     <tr> <td> <code>type</code> </td> <td>This is the type that will be imported.</td> </tr>
...
public final class ImportDirective extends Object implements IDirective
{
     ...
     */
    public ImportDirective setType(final TypeSpecifier value)
    {
        final ImportDirective result = this.copy();
        result.type = value;
        return result;
    }
     ...
     */
    public ImportDirective setLocation(final SourceLocation value)
    {
        final ImportDirective result = this.copy();
     ...
     */
    public static ImportDirective create(TypeSpecifier type, SourceLocation location)
    {
        ImportDirective object = new ImportDirective();
    ...
    {
        final ImportDirective result = new ImportDirective();
