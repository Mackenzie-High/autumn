...
public final class ValStatement extends Object implements IStatement
{
     ...
     */
    public ValStatement setVariable(final Variable value)
    {
        final ValStatement result = this.copy();
     ...
     */
    public ValStatement setValue(final IExpression value)
    {
        final ValStatement result = this.copy();
        result.value = value;
        return result;
     ...
     */
    public ValStatement setLocation(final SourceLocation value)
    {
        final ValStatement result = this.copy();
     ...
     */
    public static ValStatement create(Variable variable, IExpression value, SourceLocation location)
    {
        ValStatement object = new ValStatement();
     ...
     */
    public ValStatement copy()
    {
        final ValStatement result = new ValStatement();
