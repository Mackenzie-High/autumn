...
public final class NotEqualsOperation extends Object implements IBinaryOperation
{
     ...
     */
    public NotEqualsOperation setLeftOperand(final IExpression value)
    {
        final NotEqualsOperation result = this.copy();
     ...
     */
    public NotEqualsOperation setRightOperand(final IExpression value)
    {
        final NotEqualsOperation result = this.copy();
     ...
     */
    public NotEqualsOperation setLocation(final SourceLocation value)
    {
        final NotEqualsOperation result = this.copy();
     ...
     */
    public static NotEqualsOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        NotEqualsOperation object = new NotEqualsOperation();
    ...
    {
        final NotEqualsOperation result = new NotEqualsOperation();
