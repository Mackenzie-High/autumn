...
/**
 * An instance of this class is an AST node that represents a statement that binds the implementation of a property's setter to an object.
 * 
 * <p> 
 * <table border="1">
...
public final class SetterStatement extends Object implements IStatement
{
     ...
     */
    public SetterStatement setOwner(final Variable value)
    {
        final SetterStatement result = this.copy();
        result.owner = value;
        return result;
    }
     ...
     */
    public SetterStatement setName(final Name value)
    {
        final SetterStatement result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public SetterStatement setModule(final TypeSpecifier value)
    {
        final SetterStatement result = this.copy();
        result.module = value;
        return result;
     ...
     */
    public SetterStatement setMethod(final Name value)
    {
        final SetterStatement result = this.copy();
        result.method = value;
        return result;
     ...
     */
    public SetterStatement setLocation(final SourceLocation value)
    {
        final SetterStatement result = this.copy();
     ...
     */
    public static SetterStatement create(Variable owner, Name name, TypeSpecifier module, Name method, SourceLocation location)
    {
        SetterStatement object = new SetterStatement();
     ...
     */
    public SetterStatement copy()
    {
        final SetterStatement result = new SetterStatement();
