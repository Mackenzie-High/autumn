...
/**
 * An instance of this class is an AST node that represents a constant in an enumeration.
 * 
 * <p> 
 * <table border="1">
 *     <tr> <td> <b>Property Name</b> </td> <td> <b>Property Description</b> </td> </tr>
 *     <tr> <td> <code>comment</code> </td> <td>This is the doc-comment applied directly to the enum-constant.</td> </tr>
 *     <tr> <td> <code>annotations</code> </td> <td>These are the annotations applied directly to the enum-constant.</td> </tr>
...
public final class EnumConstant extends Object implements IAnnotated, IDocumented
{
     ...
     */
    public EnumConstant setComment(final DocComment value)
    {
        final EnumConstant result = this.copy();
     ...
     */
    public EnumConstant setAnnotations(final AnnotationList value)
    {
        final EnumConstant result = this.copy();
     ...
     */
    public EnumConstant setName(final Name value)
    {
        final EnumConstant result = this.copy();
        result.name = value;
        return result;
     ...
     */
    public EnumConstant setLocation(final SourceLocation value)
    {
        final EnumConstant result = this.copy();
     ...
     */
    public static EnumConstant create(DocComment comment, AnnotationList annotations, Name name, SourceLocation location)
    {
        EnumConstant object = new EnumConstant();
    ...
    {
        final EnumConstant result = new EnumConstant();
