...
public final class NullCoalescingOperation extends Object implements IBinaryOperation
{
     ...
     */
    public NullCoalescingOperation setLeftOperand(final IExpression value)
    {
        final NullCoalescingOperation result = this.copy();
     ...
     */
    public NullCoalescingOperation setRightOperand(final IExpression value)
    {
        final NullCoalescingOperation result = this.copy();
     ...
     */
    public NullCoalescingOperation setLocation(final SourceLocation value)
    {
        final NullCoalescingOperation result = this.copy();
     ...
     */
    public static NullCoalescingOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        NullCoalescingOperation object = new NullCoalescingOperation();
     ...
     */
    public NullCoalescingOperation copy()
    {
        final NullCoalescingOperation result = new NullCoalescingOperation();
