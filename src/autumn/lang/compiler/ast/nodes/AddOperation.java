...
public final class AddOperation extends Object implements IBinaryOperation
{
     ...
     */
    public AddOperation setLeftOperand(final IExpression value)
    {
        final AddOperation result = this.copy();
     ...
     */
    public AddOperation setRightOperand(final IExpression value)
    {
        final AddOperation result = this.copy();
     ...
     */
    public AddOperation setLocation(final SourceLocation value)
    {
        final AddOperation result = this.copy();
     ...
     */
    public static AddOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
