...
public final class XorOperation extends Object implements IBinaryOperation
{
     ...
     */
    public XorOperation setLeftOperand(final IExpression value)
    {
        final XorOperation result = this.copy();
     ...
     */
    public XorOperation setRightOperand(final IExpression value)
    {
        final XorOperation result = this.copy();
     ...
     */
    public XorOperation setLocation(final SourceLocation value)
    {
        final XorOperation result = this.copy();
     ...
     */
    public static XorOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        XorOperation object = new XorOperation();
     ...
     */
    public XorOperation copy()
    {
        final XorOperation result = new XorOperation();
