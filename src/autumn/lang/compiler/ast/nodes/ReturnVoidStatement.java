...
public final class ReturnVoidStatement extends Object implements IStatement
{
     ...
     */
    public ReturnVoidStatement setLocation(final SourceLocation value)
    {
        final ReturnVoidStatement result = this.copy();
     ...
     */
    public static ReturnVoidStatement create(SourceLocation location)
    {
        ReturnVoidStatement object = new ReturnVoidStatement();
     ...
     */
    public ReturnVoidStatement copy()
    {
        final ReturnVoidStatement result = new ReturnVoidStatement();
