 ...
 *     <tr> <td> <code>variable</code> </td> <td>This is the variable that is being declared.</td> </tr>
 *     <tr> <td> <code>value</code> </td> <td>This expression is used to initialize the variable and specify its type.</td> </tr>
...
public final class VarStatement extends Object implements IStatement
{
     ...
     */
    public VarStatement setVariable(final Variable value)
    {
        final VarStatement result = this.copy();
     ...
     */
    public VarStatement setValue(final IExpression value)
    {
        final VarStatement result = this.copy();
        result.value = value;
        return result;
     ...
     */
    public VarStatement setLocation(final SourceLocation value)
    {
        final VarStatement result = this.copy();
     ...
     */
    public static VarStatement create(Variable variable, IExpression value, SourceLocation location)
    {
        VarStatement object = new VarStatement();
     ...
     */
    public VarStatement copy()
    {
        final VarStatement result = new VarStatement();
