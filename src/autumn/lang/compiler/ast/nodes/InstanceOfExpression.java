 ...
 *     <tr> <td> <code>value</code> </td> <td>This is the value that may be an instance of the type.</td> </tr>
 *     <tr> <td> <code>type</code> </td> <td>This is the type that the value may be an instance of.</td> </tr>
...
public final class InstanceOfExpression extends Object implements IExpression
{
     ...
     */
    public InstanceOfExpression setValue(final IExpression value)
    {
        final InstanceOfExpression result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public InstanceOfExpression setType(final TypeSpecifier value)
    {
        final InstanceOfExpression result = this.copy();
        result.type = value;
        return result;
     ...
     */
    public InstanceOfExpression setLocation(final SourceLocation value)
    {
        final InstanceOfExpression result = this.copy();
     ...
     */
    public static InstanceOfExpression create(IExpression value, TypeSpecifier type, SourceLocation location)
    {
        InstanceOfExpression object = new InstanceOfExpression();
    ...
    {
        final InstanceOfExpression result = new InstanceOfExpression();
