...
public final class OrOperation extends Object implements IBinaryOperation
{
     ...
     */
    public OrOperation setLeftOperand(final IExpression value)
    {
        final OrOperation result = this.copy();
     ...
     */
    public OrOperation setRightOperand(final IExpression value)
    {
        final OrOperation result = this.copy();
     ...
     */
    public OrOperation setLocation(final SourceLocation value)
    {
        final OrOperation result = this.copy();
     ...
     */
    public static OrOperation create(IExpression left_operand, IExpression right_operand, SourceLocation location)
    {
        OrOperation object = new OrOperation();
     ...
     */
    public OrOperation copy()
    {
        final OrOperation result = new OrOperation();
