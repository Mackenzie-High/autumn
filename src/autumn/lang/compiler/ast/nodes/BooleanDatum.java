...
public final class BooleanDatum extends Object implements IDatum
{
     ...
     */
    public BooleanDatum setValue(final boolean value)
    {
        final BooleanDatum result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public BooleanDatum setLocation(final SourceLocation value)
    {
        final BooleanDatum result = this.copy();
     ...
     */
    public static BooleanDatum create(boolean value, SourceLocation location)
    {
        BooleanDatum object = new BooleanDatum();
     ...
     */
    public BooleanDatum copy()
    {
        final BooleanDatum result = new BooleanDatum();
