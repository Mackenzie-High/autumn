 ...
 *     <tr> <td> <code>variable</code> </td> <td>This is the variable that is being assigned a new value.</td> </tr>
 *     <tr> <td> <code>value</code> </td> <td>This expression produces the value to assign to the variable.</td> </tr>
...
public final class LetStatement extends Object implements IStatement
{
     ...
     */
    public LetStatement setVariable(final Variable value)
    {
        final LetStatement result = this.copy();
     ...
     */
    public LetStatement setValue(final IExpression value)
    {
        final LetStatement result = this.copy();
        result.value = value;
        return result;
     ...
     */
    public LetStatement setLocation(final SourceLocation value)
    {
        final LetStatement result = this.copy();
     ...
     */
    public static LetStatement create(Variable variable, IExpression value, SourceLocation location)
    {
        LetStatement object = new LetStatement();
