...
public final class RedoStatement extends Object implements IStatement
{
     ...
     */
    public RedoStatement setLocation(final SourceLocation value)
    {
        final RedoStatement result = this.copy();
     ...
     */
    public RedoStatement copy()
    {
        final RedoStatement result = new RedoStatement();
