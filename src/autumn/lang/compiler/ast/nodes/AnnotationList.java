 ...
 *     <tr> <td> <code>annotations</code> </td> <td>These are the annotation-usages themselves.</td> </tr>
...
public final class AnnotationList extends Object implements IConstruct
{
    private ConstructList<Annotation> annotations = new ConstructList();
     ...
     */
    public AnnotationList setAnnotations(final ConstructList<Annotation> value)
    {
        final AnnotationList result = this.copy();
     ...
     */
    public ConstructList<Annotation> getAnnotations()
    {
        final ConstructList<Annotation> value = this.annotations;
        return value;
    }
     ...
     */
    public AnnotationList setLocation(final SourceLocation value)
    {
        final AnnotationList result = this.copy();
     ...
     */
    public static AnnotationList create(ConstructList<Annotation> annotations, SourceLocation location)
    {
        AnnotationList object = new AnnotationList();
    ...
    {
        final AnnotationList result = new AnnotationList();
