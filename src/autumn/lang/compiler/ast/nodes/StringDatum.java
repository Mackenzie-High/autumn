...
public final class StringDatum extends Object implements IDatum
{
     ...
     */
    public StringDatum setValue(final String value)
    {
        final StringDatum result = this.copy();
        result.value = value;
        return result;
     ...
     */
    public StringDatum setLocation(final SourceLocation value)
    {
        final StringDatum result = this.copy();
