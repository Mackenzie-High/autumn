...
public final class ByteDatum extends Object implements IDatum
{
    private ByteLiteral value;
     ...
     */
    public ByteDatum setValue(final ByteLiteral value)
    {
        final ByteDatum result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public ByteLiteral getValue()
    {
        final ByteLiteral value = this.value;
        return value;
    }
     ...
     */
    public ByteDatum setLocation(final SourceLocation value)
    {
        final ByteDatum result = this.copy();
     ...
     */
    public static ByteDatum create(ByteLiteral value, SourceLocation location)
    {
        ByteDatum object = new ByteDatum();
     ...
     */
    public ByteDatum copy()
    {
        final ByteDatum result = new ByteDatum();
