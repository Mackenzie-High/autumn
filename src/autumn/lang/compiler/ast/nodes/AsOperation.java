...
public final class AsOperation extends Object implements IConversionOperation
{
     ...
     */
    public AsOperation setValue(final IExpression value)
    {
        final AsOperation result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public AsOperation setType(final TypeSpecifier value)
    {
        final AsOperation result = this.copy();
        result.type = value;
        return result;
     ...
     */
    public AsOperation setLocation(final SourceLocation value)
    {
        final AsOperation result = this.copy();
     ...
     */
    public AsOperation copy()
    {
        final AsOperation result = new AsOperation();
