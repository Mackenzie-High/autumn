...
public final class WhileStatement extends Object implements IStatement
{
     ...
     */
    public WhileStatement setCondition(final IExpression value)
    {
        final WhileStatement result = this.copy();
     ...
     */
    public WhileStatement setBody(final SequenceStatement value)
    {
        final WhileStatement result = this.copy();
        result.body = value;
        return result;
     ...
     */
    public WhileStatement setLocation(final SourceLocation value)
    {
        final WhileStatement result = this.copy();
     ...
     */
    public static WhileStatement create(IExpression condition, SequenceStatement body, SourceLocation location)
    {
        WhileStatement object = new WhileStatement();
    ...
    {
        final WhileStatement result = new WhileStatement();
