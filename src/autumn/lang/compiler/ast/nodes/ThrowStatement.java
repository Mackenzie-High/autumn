 ...
 *     <tr> <td> <code>value</code> </td> <td>This expression produces the exception object to throw.</td> </tr>
...
public final class ThrowStatement extends Object implements IStatement
{
     ...
     */
    public ThrowStatement setValue(final IExpression value)
    {
        final ThrowStatement result = this.copy();
        result.value = value;
        return result;
    }
     ...
     */
    public ThrowStatement setLocation(final SourceLocation value)
    {
        final ThrowStatement result = this.copy();
     ...
     */
    public static ThrowStatement create(IExpression value, SourceLocation location)
    {
        ThrowStatement object = new ThrowStatement();
    ...
    {
        final ThrowStatement result = new ThrowStatement();
