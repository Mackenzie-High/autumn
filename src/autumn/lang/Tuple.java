 ...
 * The returned instance must be readonly.
 ...
 * cause unbounded recursion in the equals(Object) method.
 * </p>
 *
                ...
                Comparable<Tuple>
{
     ...
     * @return this tuple, if this tuple is mutable; otherwise, returned a modified copy thereof.
     */
    public Tuple<T> set(String index,
                        Object value);
    ...
    /**
     * This method determines whether this tuple is readonly.
     *
     * @return ! isMutable().
     */
     ...
     * If this tuple is readonly, then the copy will be readonly.
     * </p>
     *
    ...
    /**
     * This method creates a readonly copy of this tuple.
     *
     * @return a readonly copy of this tuple.
     */
    public Tuple<T> readonlyCopy();
