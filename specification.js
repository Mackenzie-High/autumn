...
"Import Directive" : {
  ...
  "details":
    [
      ...
      [1, "autumn.util.data.json.Json"],
      [1, "autumn.util.data.json.JsonArray"],
      [1, "autumn.util.data.json.JsonBoolean"],
      [1, "autumn.util.data.json.JsonMap"],
      [1, "autumn.util.data.json.JsonNull"],
      [1, "autumn.util.data.json.JsonNumber"],
      [1, "autumn.util.data.json.JsonValue"],
      [1, "autumn.util.ds.Counter"],
...
"Functor Definition" : {
  ...
  "static-checks":
    [
      ...
      ["EXPECTED_CLASS_TYPE", "The type of <i>super</i> must be a class-type.", "null"],
      ["EXPECTED_FUNCTOR_TYPE", "The <i>super</i> must be a subtype of <a href=\"http://mackenzie-high.github.io/autumn/javadoc/autumn/lang/Functor.html\">Functor</a>.", "null"],
      ["CIRCULAR_INHERITANCE", "The new type cannot be a subtype of itself either directly or indirectly.", "null"],
    ],
...
"Delegate Statement" : {
  ...
  "static-checks":
    [
      ...
      ["EXPECTED_MODULE", "The <i>module</i> must be a subtype of #AutumnLangModule#.", "null"],
    ],
},
...
"Equality Operation" : {
  ...
  "details":
    [
      ...
      [1, "The left-operand is evaluated first."],
      [1, "The right-operand is evaluated second."],
      [0, "<a href=\"http://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html\">BigDecimal</a> objects are compared using their compareTo(<a href=\"http://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html\">BigDecimal</a>) method."],
      [1, "This avoids the non-intuitive behavior of their equals(<a href=\"http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html\">Object</a>) method."],
      [0, "Return Type: boolean"],
